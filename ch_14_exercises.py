...
dogs_cursor.execute("""INSERT INTO Dogs (DogName, OwnerName, Breed)
                    ...
                    ("Spark", "Jacob", "Chihuahua"),
                    ("Max", "Lucy", "German Shepherd"),
                    ("Lucy", "Jaden", "Dachshund")
                    """)
...
for row in results:
    print(f'{row[0]:1} {row[1]:10} {row[2]:10} {row[3]:20}')
